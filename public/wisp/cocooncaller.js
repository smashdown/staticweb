...
function showMG(){
	//alert("ok");
	window.location = "http://games.playtouch.net/ad/moregame/nococoon.php?device="+_platform+"&gamename="+_gamename;
	//window.open("http://ks388498.kimsufi.com/ad/applift/nococoon.php?device="+ _platform);
